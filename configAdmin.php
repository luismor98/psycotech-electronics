    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">Psycotech Electronics</small></h1>
            </div>
            <!-- Nav tabs -->
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="process/regprove.php" method="post" role="form">
                                <div class="form-group">
                                    <label>Código</label>
                                    <input class="form-control" type="text" name="prove-nit" placeholder="Código proveedor" maxlength="30" required="">
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
