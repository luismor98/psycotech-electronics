    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <p class="text-center">
                    <a href="pedido.php" class="btn btn-success btn-block"> Bs. Confirmar pedido</a>
...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs"><!-- Menu computadoras y tablets -->
            <div class="col-xs-4">
                ...
                <p class="text-navbar tittles-pages-logo">Psycotech Electronics C.A</p>
            </div>
            <div class="col-xs-8">
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en Psycotech Electronics</h4>
                </div>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">Psycotech Electronics</h3>
